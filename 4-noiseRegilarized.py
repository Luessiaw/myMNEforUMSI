...
varName = "noiseRegularized"
refreshMode = 3 # 不需要重新计算 L 和 W
xs = np.linspace(0,200,21)*1e-15
xticks = xs*1e15
...
saveFolder = os.path.join("figs","regularized-deadzone",f"{varName}","no-consider-x")
